...
m.objective= xsum(X[w,r,d] for w in range(len(workers)) for r in range(len(roles)) for d in range(len(days)-2))\
                ...
                + xsum(X[w,r,d] for w in range(1) for r in range(1) for d in range(len(days)-2))*10 \
                - xsum(X[w,r,d] for w in range(len(workers)) for r in range(len(roles)) for d in range(len(days)-2,len(days)))*100000
...
for w in range(len(workers)):
    for d in range(len(days)):
        m.add_constr(xsum(X[w,r,d] + P[(w,r,d)] for r in range(len(roles))) <= 1)
